use update_planner_parser::{DefaultExecutor, DocumentSet, SimplePlanner, UpdatePlanner, PlanExecutor};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let docs = DocumentSet {
        cards: vec![
            ...
            Card { card_type: CardType::Bidirectional, fields: vec!["Front".into(), "Back".into()] },
        ],
